...
public class RecommendationRequestControllerTests extends ControllerTestCase {
        ...
        public void an_admin_user_can_post_a_new_recommendationrequest() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/RecommendationRequest/post?requesterEmail=tmcanepa@ucb.edu&professorEmail=phtcon@ucsb.edu&explanation=I need a recommendation for grad school&dateRequested=2022-01-03T00:00:00&dateNeeded=2022-01-03T00:00:00&done=false")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
